      ...
      <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
          <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
              <div className="col-span-2 md:col-span-3 lg:col-span-2 lg:pr-8">
                  ...
                  <h1 className='text-3xl font-bold'>The Mombasa Spa</h1>

                  <p className="text-base leading-relaxed text-gray-600 mt-7">If you've ever wondered what hairstyles suit you and how you should cut your hair, here's a list of the top styles for all men.</p>
          ...
          <p className="text-sm text-center text-gray-600">© Copyright 2022, All Rights Reserved by KandyDev</p>
      </div>
  </section>
