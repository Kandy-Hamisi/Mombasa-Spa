...
const Hero = () => {
  return (
    <section className='bg-salon w-full'>
        <div className='flex lg: flex-col text-center lg:text-left lg:justify-start items-center justify-center  min-h-screen ml-16'>
            ...
            <div className='flex space-x-2 mt-[1.5rem]'>
                <div className='lg:absolute top-[75%] left-[65%] flex items-center space-x-2'>
                ...
                <div className='lg:absolute top-[25%] left-[75%] flex items-center space-x-2'>
                    <div className='h-[75px] w-[75px] relative flex'>
                        <Image
                            src="https://cdn.pixabay.com/photo/2015/09/11/23/27/woman-936549_960_720.jpg"
                            className='object-cover rounded-full'
