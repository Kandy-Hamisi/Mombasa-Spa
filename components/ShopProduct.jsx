...
const ShopProduct = () => {
  ...
  return (
    <div className='grid grid-cols-2 gap-6 mt-10 lg:mt-16 lg:gap-4 lg:grid-cols-4'>
        { products.map(item => <div class="relative group">
            <div class="overflow-hidden aspect-w-1 aspect-h-1">
                <img class="object-cover w-full h-full transition-all duration-300 group-hover:scale-125" src={item.url} alt={item.alt} />
            </div>
